...
//        return getStudentOredersTwoSelect();
        return getStudentOredersOneSelect();
    }
    private List<StudentOrder> getStudentOredersOneSelect() throws DaoException {
    ...
    private List<StudentOrder> getStudentOredersTwoSelect() throws DaoException {
        List<StudentOrder> result = new LinkedList<>();
    ...
    private Child fillChild(ResultSet rs) throws SQLException {
        ...
        address.setStreet(st);
//        address.setPostCode(rs.getString( "ñ_post_index"));
//        address.setBuilding(rs.getString(  "ñ_building"));
//        address.setExtension(rs.getString("ñ_extension"));
//        address.setApartment(rs.getString("ñ_apartment"));
